...
def patch_webview_css(webview_css: Path) -> bool:
    ...
    new = old + modal_overlay_rule + (
        ...
        ".ccPatchDefArHead{font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:.4px;opacity:.5;margin:12px 0 3px}"
        ".ccPatchDefCheckRow{display:flex;align-items:center;gap:10px;padding:5px 4px;border-radius:6px;cursor:pointer}"
        ".ccPatchDefCheckRow:hover{background:var(--app-list-hover-background,rgba(255,255,255,.06))}"
        ".ccPatchDefCheckLabel{font-size:12.5px}"
        ".ccPatchChk{width:16px;height:16px;flex:0 0 auto;box-sizing:border-box;border-radius:4px;"
        "border:1.5px solid var(--app-border-color,rgba(255,255,255,.32));display:flex;align-items:center;justify-content:center}"
        ".ccPatchChk svg{opacity:0}"
        ".ccPatchChkOn{background:#2563eb;border-color:#2563eb}"
        ".ccPatchChkOn svg{opacity:1}"
