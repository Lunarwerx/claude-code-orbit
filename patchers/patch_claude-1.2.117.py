...
def patch_webview_css(webview_css: Path) -> bool:
    ...
    new = old + modal_overlay_rule + (
        ...
        ".ccPatchUsageMenu{position:fixed;z-index:100000;padding:13px 16px 15px;width:min(440px,calc(100vw - 16px));box-sizing:border-box;"
