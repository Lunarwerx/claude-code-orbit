...
try{if(!globalThis.ccPatchAutoRefreshTimer)globalThis.ccPatchAutoRefreshTimer=setInterval(function(){try{var r=globalThis.ccPatchSessionsRoot;if(r&&!document.documentElement.classList.contains(`ccPatchPaneHidden`)){if(r.listSessions)r.listSessions();if(r.listRemoteSessions)r.listRemoteSessions()}}catch(e){}},7000)}catch(e){}
