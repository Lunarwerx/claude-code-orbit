...
def patch_webview_css(webview_css: Path) -> bool:
    ...
    new = old + modal_overlay_rule + (
        ...
        # Background task-notifications (native Claude Code) — reframed from a raw
        # debug-log-looking user message into a tidy "Background task" card.
        '[data-cc-tasknote]{opacity:.9;border-left:2px solid var(--app-primary-border-color,#555);padding-left:10px;font-size:11px;line-height:1.45;color:var(--app-secondary-foreground,#9aa0a6)}'
        '[data-cc-tasknote]::before{content:"\\2699  " attr(data-cc-tasknote-label);display:block;font-size:11.5px;font-weight:600;color:var(--app-foreground,#d6d6d6);margin-bottom:3px;white-space:normal}'
