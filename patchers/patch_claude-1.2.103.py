...
def patch_webview_css(webview_css: Path) -> bool:
    ...
    new = old + modal_overlay_rule + (
        ...
        ".ccPatchConfirmDesc{font-size:12.5px;opacity:.78;line-height:1.55;margin:0 4px 13px;max-width:320px}"
        ".ccPatchConfirmNote{font-size:11px;opacity:.5;line-height:1.5;margin:0 4px 14px;max-width:320px;"
        "padding-top:12px;border-top:1px solid var(--app-primary-border-color)}"
