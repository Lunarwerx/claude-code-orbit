...
def patch_webview_js(webview_js: Path) -> bool:
    ...
    mode_new = (
        ...
        f'onSelect:(ccPE)=>{{if(ccPE==="bypassPermissions"){{var ccGo=function(){{ccPatchAutoApproveSet({XE}.claudeChannelId,!0);{XE}.setPermissionMode("bypassPermissions",!0)}};if(ccPatchYoloConfirmedGet())ccGo();else ccPatchYoloConfirm(ccGo)}}else{{ccPatchAutoApproveSet({XE}.claudeChannelId,!1);{XE}.setPermissionMode(ccPE,!0)}}}},anchorRight:!0}}))'
    )
