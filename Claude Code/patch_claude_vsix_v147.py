...
def patch_webview_js(webview_js: Path) -> bool:
    ...
    inline_body = (
        ...
        f"onClick:function(e){{ccPatchShowSettingsMenu(e,{fe1['Z']})}}}}," 
        f'{p0}.default.createElement("svg",{{width:14,height:14,viewBox:"0 0 14 14",fill:"none",'
...
def patch_webview_css(webview_css: Path) -> bool:
    ...
    new = old + (
        ...
        ".claudePatchInlineSessions{order:2;position:relative;z-index:1;"
        ...
        # YOLO ON state -- controlled via settings menu item extra tag
        ".ccPatchSettingsItemExtra{font-size:9px;font-weight:700;padding:1px 5px;border-radius:3px;"
        "margin-left:auto;text-transform:uppercase;letter-spacing:.04em;"
        "background:rgba(249,115,22,.16);color:#f97316}"
