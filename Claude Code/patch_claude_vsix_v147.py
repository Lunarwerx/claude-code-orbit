...
def patch_extension_host_js(path: Path) -> bool:
    ...
    insert = (
        ...
        f'try{{if({fs_id}.existsSync(ccP)){{ccC={fs_id}.readFileSync(ccP,"utf8");ccE=true}}}}catch(e){{}}'
        ...
        f'try{{{fs_id}.mkdirSync({path_id}.dirname(ccP),{{recursive:!0}});'
